...
namespace SalesManagement.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesManagementContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@email.com", new DateTime(1998, 4, 21), 1500.0, d1);
            Seller s2 = new Seller(2, "Maria Red", "maria@email.com", new DateTime(1990, 3, 12), 1500.0, d2);
            Seller s3 = new Seller(3, "Alex Green", "alex@email.com", new DateTime(2000, 6, 14), 1500.0, d1);
            Seller s4 = new Seller(4, "Donald Black", "donald@email.com", new DateTime(1989, 10, 04), 1500.0, d3);
            Seller s5 = new Seller(5, "Iris Gray", "iris@email.com", new DateTime(1997, 11, 09), 1500.0, d3);
            Seller s6 = new Seller(6, "Venus Yellow", "venus@email.com", new DateTime(1992, 12, 11), 1500.0, d2);
